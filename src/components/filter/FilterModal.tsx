            ...
            <View style={styles.chipContainer}>
              {[
                ...
                <FilterChip
                  ...
                  onPress={() =>
                    setSort(
                      item.value === sort ? "dateDesc" : (item.value as any),
                    )
                  }
                  theme={theme}
                />
            ...
            <View style={styles.chipContainer}>
              {[
                ...
                <FilterChip
                  ...
                  onPress={() =>
                    setDateRange(
                      dateRange === item.value ? null : (item.value as any),
                    )
                  }
                  theme={theme}
                />
              ...
              <View style={styles.chipContainer}>
                ...
                {rockets.map((r) => (
                  <FilterChip
                    key={r}
                    label={r}
                    selected={rocket === ROCKET_IDS[r]}
                    onPress={() => {
                      const id = ROCKET_IDS[r];
                      setRocket(rocket === id ? null : id);
                    }}
                    theme={theme}
                  />
                ))}
              ...
              <View style={styles.chipContainer}>
                ...
                {launchpads?.map((lp) => (
                  <FilterChip
                    ...
                    onPress={() =>
                      setLaunchpad(launchpad === lp.id ? null : lp.id)
                    }
                    theme={theme}
                  />
                ))}
